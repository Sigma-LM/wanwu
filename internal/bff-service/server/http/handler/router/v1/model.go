...
func registerModel(apiV1 *gin.RouterGroup) {
	...
	mid.Sub("model.model_management").Reg(apiV1, "/model", http.MethodGet, v1.GetModel, "查询单个模型")
	...
	mid.Sub("model.model_management").Reg(apiV1, "/model/experience/llm", http.MethodPost, v1.ModelExperienceLLM, "LLM模型体验")
	mid.Sub("model.model_management").Reg(apiV1, "/model/experience/dialog", http.MethodPost, v1.ModelExperienceSaveDialog, "保存模型体验对话")
