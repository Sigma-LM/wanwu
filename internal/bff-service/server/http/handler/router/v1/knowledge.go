...
func registerKnowledge(apiV1 *gin.RouterGroup) {
	// 知识库增删改查
	mid.Sub("resource.knowledge").Reg(apiV1, "/knowledge", http.MethodPost, v1.CreateKnowledge, "创建知识库（文档分类）")
	...
	mid.Sub("resource.knowledge").Reg(apiV1, "/knowledge/hit", http.MethodPost, v1.KnowledgeHit, "知识库命中测试")
	...
	mid.Sub("resource.knowledge").Reg(apiV1, "/knowledge/qa/hit", http.MethodPost, v1.KnowledgeQAHit, "问答库命中测试")
